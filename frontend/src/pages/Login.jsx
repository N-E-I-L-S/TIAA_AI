          ...
          <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
              <h1 className="justify-center text-center">
                <span className="text-6xl text-center font-title tracking-tight text-blue-100 sm:text-6xl">
                  Hire2
                </span>
                <span className="text-6xl text-center font-title tracking-tight text-blue-900 sm:text-6xl">
                  Retire
                </span>
              </h1>
